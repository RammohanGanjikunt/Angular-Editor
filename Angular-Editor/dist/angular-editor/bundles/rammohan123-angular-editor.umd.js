(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@rammohan123/angular-editor', ['exports', '@angular/core', '@angular/common/http', '@angular/common', '@angular/forms', '@angular/platform-browser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.rammohan123 = global.rammohan123 || {}, global.rammohan123['angular-editor'] = {}), global.ng.core, global.ng.common.http, global.ng.common, global.ng.forms, global.ng.platformBrowser));
    ...
    var AngularEditorService = /** @class */ (function () {
        ...
        AngularEditorService.prototype.createLink = function (url) {
            if (!url.includes('http')) {
                ...
                var newUrl = '<a href="' + url + '" target="_blank" external="true">' + this.selectedText + '</a>';
    ...
    var AngularEditorComponent = /** @class */ (function () {
        ...
        AngularEditorComponent.prototype.ngOnChanges = function (changes) {
        ...
        */
        AngularEditorComponent.prototype.getCaretCharacterOffsetWithin = function (element) {
            var caretOffset = 0;
        ...
        AngularEditorComponent.prototype.getCaretPosition = function (el) {
        ...
        AngularEditorComponent.prototype.showCaretPos = function (element) {
            if (element) {
                return this.getAbsPosition(this.getCaretCharacterOffsetWithin(element), element);
            }
            return null;
        };
        AngularEditorComponent.prototype.getAbsPosition = function (num, element) {
            var text = element.innerHTML;
            var pos = 0;
            var count = 0;
            var htmlIndexes = this.findHTMLIndexes(text);
            for (var index = 0; index < text.length; index++) {
                var state = false;
                for (var j = 0; j < htmlIndexes.length; j++) {
        ...
        AngularEditorComponent.prototype.findHTMLIndexes = function (htmlString) {
            var index = 0;
            var htmlIndexes = [];
            while (index < htmlString.length) {
                var start = htmlString.indexOf('<', index);
                if (start > -1) {
                    var end = htmlString.indexOf('>', start + 1);
                    htmlIndexes.push({
                        start: start,
                        end: end
                    });
    ...
    AngularEditorComponent.propDecorators = {
        ...
        dataEvent: [{ type: core.Output, args: ['data',] }],
...
//# sourceMappingURL=rammohan123-angular-editor.umd.js.map
