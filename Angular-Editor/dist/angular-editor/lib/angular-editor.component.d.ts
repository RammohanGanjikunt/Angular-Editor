...
export declare class AngularEditorComponent implements OnInit, ControlValueAccessor, AfterViewInit, OnDestroy, OnChanges {
    private r;
    ...
    getCaretCharacterOffsetWithin(element: any): number;
    getCaretPosition(el: any): number;
    showCaretPos(element: any): number;
    getAbsPosition(num: number, element: any): number;
    findHTMLIndexes(htmlString: string): any[];
}
